...
//     if (services="nails" &&services="hair")  {
//         alert('welcome to the salon');
//     } else if
//      (services="massage " || 'wax' )
//      {
//         alert('sorry we dont have this servies');
//     } else {
...
var number = prompt("how many services you will take?");
function getNumber(services) {

    console.log(services);
    if (services >= 2 && services <= 5) {
        alert('welcome to the our salon');
    } else if (services < 0 || services > 0) {
        alert('sorry ');
    } else {
